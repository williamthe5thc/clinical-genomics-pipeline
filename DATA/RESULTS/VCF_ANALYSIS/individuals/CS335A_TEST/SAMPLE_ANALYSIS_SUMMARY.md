# Clinical Genomics Analysis Summary: CS335A_TEST

**Analysis Date:** 2025-09-27 11:04:04  
...
- **Annotated VCF:** `vep_annotation/CS335A_TEST_comprehensive.vcf.gz`
- **VCF Index:** `vep_annotation/CS335A_TEST_comprehensive.vcf.gz.tbi`
- **VEP Statistics:** `vep_annotation/CS335A_TEST_comprehensive_stats.html`
- **VEP Warnings:** `vep_annotation/CS335A_TEST_comprehensive_warnings.txt`

### Clinical Analysis Results  
- **ACMG Report:** `clinical_analysis/CS335A_TEST_enhanced_acmg_results.txt`
- **Multi-Specialty Report:** `clinical_analysis/CS335A_TEST_multi_specialty_report.html`
- **Analysis Summary:** `clinical_analysis/CS335A_TEST_analysis_summary.json`
...
cd "/mnt/d/Genome/DATA/RESULTS/VCF_ANALYSIS/individuals/CS335A_TEST"

# View main clinical findings
cat clinical_analysis/CS335A_TEST_enhanced_acmg_results.txt

# Open interactive HTML report (if available)
firefox clinical_analysis/CS335A_TEST_multi_specialty_report.html

# Check VEP annotation statistics
firefox vep_annotation/CS335A_TEST_comprehensive_stats.html

# Query specific variants from annotated VCF
bcftools view vep_annotation/CS335A_TEST_comprehensive.vcf.gz | head -100

# Search for pathogenic variants
zcat vep_annotation/CS335A_TEST_comprehensive.vcf.gz | grep -i pathogenic
